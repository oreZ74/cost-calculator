...
public class ExpenseTable {
    ...
    TableColumn<Expense, String> name_column = new TableColumn<>("Name");
    TableColumn<Expense, String> budget_column = new TableColumn<>("Budget");
    TableColumn<Expense, String> actual_column = new TableColumn<>("Actual");
    TableColumn<Expense, String> difference_column = new TableColumn<>("Difference");
    ...
    public void setTable(TableView<Expense> table) {
        this.table = table;
    }

    public TableColumn<Expense, String> getName_column() {
        return name_column;
    }

    public void setName_column(TableColumn<Expense, String> name_column) {
        this.name_column = name_column;
    }

    public TableColumn<Expense, String> getBudget_column() {
        return budget_column;
    }

    public void setBudget_column(TableColumn<Expense, String> budget_column) {
        this.budget_column = budget_column;
    }

    public TableColumn<Expense, String> getActual_column() {
        return actual_column;
    }

    public void setActual_column(TableColumn<Expense, String> actual_column) {
        this.actual_column = actual_column;
    }

    public TableColumn<Expense, String> getDifference_column() {
        return difference_column;
    }

    public void setDifference_column(TableColumn<Expense, String> difference_column) {
